...
export default function Checkout() {
  ...
  const validate = () => {
    ...
    if (!form.address.trim() && form.delivery !== "Ridicare din depozit") e.address = "Câmp obligatoriu";
    return e;
  };
  ...
  const handleSubmit = (ev: React.FormEvent) => {
    ...
    const order = storeActions.addOrder({
    ...
    if (adminPhone) {
      const shippingLine = total >= 5000 ? "Gratuită" : "150 MDL";
      ...
      const msg = [
        ...
        `📍 ${form.address || "Ridicare din depozit"} (${form.delivery})`,
        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-white rounded-2xl border border-zinc-200 p-5 mb-6 text-left">
            ...
            <div className="space-y-2 text-sm text-zinc-600">
              ...
              <p>✓ Pregătire comandă în depozit (1-2 ore)</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            {getState().settings.general?.adminPhone && (
              <a
                href={`viber://chat?number=${getState().settings.general.adminPhone}`}
  ...
  const F = ({ label, field, type = "text", placeholder = "", icon: Icon }: {
    label: string; field: keyof FormData; type?: string; placeholder?: string; icon?: React.ElementType;
  }) => (
    <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-zinc-200 p-5 md:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2"><F label="Nume și Prenume *" field="name" icon={User} placeholder="Ion Popescu" /></div>
                <F label="Telefon *" field="phone" type="tel" icon={Phone} placeholder="+373 69 XXX XXX" />
                <F label="Email (opțional)" field="email" type="email" icon={Mail} placeholder="email@exemplu.md" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-zinc-200 p-5 md:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                {["Livrare la domiciliu", "Livrare curier express", "Ridicare din depozit"].map((opt) => (
                  <button
                    key={opt}
                    type="button"
              ...
              {form.delivery !== "Ridicare din depozit" && (
                <F label="Adresa de livrare *" field="address" icon={MapPin} placeholder="Str. Exemplu 12, ap. 5, Chișinău" />
              )}
            </div>
            ...
            <p className="text-center text-xs text-zinc-400">Plata se face la livrare sau la ridicare. Fără taxe ascunse.</p>
          </form>
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <div className="bg-white rounded-2xl border border-zinc-200 p-5 md:p-6">
              ...
              <div className="mt-4 bg-zinc-50 rounded-xl p-3 text-xs text-zinc-500 space-y-1">
                <p>✓ Garanție 5 ani pe echipamente</p>
